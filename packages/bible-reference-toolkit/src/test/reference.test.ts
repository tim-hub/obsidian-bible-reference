...
describe('Reference Original Test in English', () => {
  ...
  test('toString() returns the text reference', () => {
    const ref = Reference.fromVerseId(32)
